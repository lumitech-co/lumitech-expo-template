...
export const TouchableOpacity = forwardRef<View, TouchableOpacityProps>(
  ({ style, children, ...rest }, ref) => {
    ...
    const { styleProps, otherProps } = separateProps<TouchableOpacityProps, ViewStyleWithColors>(
      rest,
      CommonStyleSchema.shape,
    );

    return (
      <BaseTouchableOpacity ref={ref} style={[styles.layout(styleProps), style]} {...otherProps}>
        {children}
...
const stylesheet = createStyleSheet(theme => ({
  layout: (props: TouchableOpacityProps) => transformComponentStyle(props, theme),
}));
