...
module.exports = [
  {
    ignores: ["node_modules/**", "dist/**", "build/**", ".expo/**", "*.config.js", "**/*.d.ts"],
  },
  ...compat.extends("plugin:react/recommended", "airbnb", "plugin:prettier/recommended"),
  {
    files: ["**/*.{js,jsx,ts,tsx}"],
    languageOptions: {
      ecmaVersion: 2021,
        ...
        2,
        {
          ...
          rules: [
            ...
            // View-Model Layer Rules
            {
              ...
              message:
                "View-model can only import from model and shared layers, not from views or other view-model",
            },
            ...
            // Models Layer Rules
            {
              ...
              message:
                "Models can only import from shared and api layers, not from presentation layers",
            },
            ...
            // Services Layer Rules
            {
              ...
              allow: ["shared", "model"],
              disallow: ["app", "view-model", "widgets", "ui"],
              message: "Services can only import from shared and model layers",
            },
            ...
            // Widgets Layer Rules
            {
              ...
              message:
                "Widgets can only import from ui and shared layers, not from business logic layers",
            },
            ...
            // API Layer Rules
            {
              from: ["api"],
              allow: ["shared"],
              disallow: ["app", "view-model", "model", "services", "widgets", "ui"],
            ...
            // Stores Layer Rules
            {
              from: ["stores"],
              allow: ["shared"],
              disallow: ["app", "view-model", "model", "services", "widgets", "ui", "api"],
